    ...
    <>
      <header className="text-slate-200 bg-slate-700 body-font mb-1 shadow-xl fixed w-full z-50">
        <div className="container mx-auto flex justify-between flex-wrap p-3 flex-row items-center">
          <Link
            href={"/"}
            className="flex title-font font-medium items-center text-yellow-500 md:mb-0"
          >
            <FaShoppingCart size={45} />
            <span className="hidden md:block ml-3 text-xl">CodeStore</span>
          </Link>
          <nav className="text-white md:mr-auto hidden md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400 md:flex flex-wrap items-center text-base justify-center">
            <Link
              href={"/tshirts"}
